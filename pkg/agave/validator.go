...
func (cmd *InstallCommand) Check() error {
	...
	if cmd.GeyserPlugin.YellowstoneGrpc != nil {
		ygrpcVersion := cmd.GeyserPlugin.YellowstoneGrpc.Version
		packageInfo.PackageGroup.Add(deb.Package{Name: "svmkit-yellowstone_grpc", Version: &ygrpcVersion})
	}
...
func (cmd *InstallCommand) Env() *runner.EnvBuilder {
	...
	if cmd.GeyserPlugin.YellowstoneGrpc != nil {
		...
		address := cmd.GeyserPlugin.YellowstoneGrpc.YellowstoneGrpcConfig.Grpc.Address
